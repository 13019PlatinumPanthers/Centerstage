...
public class CSrobotRG {
    ...
    public CSrobotRG(OpMode op ) {
        ...
        Drive = new CSDriveTrainRG( hardwareMap, leftFrontDrive,rightFrontDrive,leftBackDrive, rightBackDrive, opMode.telemetry);

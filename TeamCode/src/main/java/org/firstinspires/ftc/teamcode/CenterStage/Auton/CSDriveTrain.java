...
public class CSDriveTrain {
    ...
    private final Orientation lastAngle = new Orientation();
    ...
    public CSDriveTrain(DcMotor leftFrontDrive,DcMotor rightFrontDrive,DcMotor leftBackDrive,DcMotor rightBackDrive, Telemetry telemetry){

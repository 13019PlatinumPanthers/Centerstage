...
public class CSDriveTrain {
    ...
    public CSDriveTrain(HardwareMap hardwareMap,DcMotor leftFrontDrive,DcMotor rightFrontDrive,DcMotor leftBackDrive,DcMotor rightBackDrive, Telemetry telemetry){
